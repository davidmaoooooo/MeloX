...
enum WatchLyricLongToneEmphasis {
    struct State {
        let isLongTone: Bool
        let envelope: Double
    ...
    static func state(
        ...
        timing: WatchLyricTimingTextAttribute,
        detectionMode: WatchLyricTimingMode,
        ...
        return State(
            ...
            expansionAmount: emphasisAmount(
                duration: duration,
    ...
    static func isLongTone(
        ...
        return !timing.isWhitespace
            && group.endTime - group.startTime
                >= max(durationThreshold, 0)
    }
...
private extension WatchLyricLongToneEmphasis {
    struct TimingGroup {
